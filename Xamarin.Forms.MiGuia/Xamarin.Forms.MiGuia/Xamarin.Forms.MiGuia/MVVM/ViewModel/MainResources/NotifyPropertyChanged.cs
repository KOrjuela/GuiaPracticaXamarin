namespace Xamarin.Forms.MiGuia.MVVM.ViewModel.MainResources
{
    ...
    {
        /// <summary>
        /// Atributo que indica si se esta procesando o no datos
        /// </summary>
        private bool _isBeingProcessed;

        /// <summary>
        /// Atributo que indica si se esta procesando o no una actualizacion
        /// </summary>
        private bool _isRefreshing;

        /// <summary>
        /// Obtiene o establece el valor del indiciador que determina si se estan procesando o no datos
        /// </summary>
        public bool IsBeingProcessed
        {
            get { return this._isBeingProcessed; }
            set { this.UpdateValueProperty(ref this._isBeingProcessed, value); }
        }

        /// <summary>
        /// Obtiene o establece el valor del indiciador que determina si se esta actualizando una lista
        /// </summary>
